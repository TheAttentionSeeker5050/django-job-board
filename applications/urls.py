...
from .views import DirectApplyCreateView, ApplicationsListView, ApplicationDetailView
...
urlpatterns = [
    ...
    path('detail/<int:application_pk>/', ApplicationDetailView.as_view(), name='applications_detail'),
